...
public:
...
#endif
    return __make_Intm(__impl_pow(a, MOD-2)); 
  }
  ...
  ATTR_INLINE CXX11_CONSTEXPR friend Intm  operator*  (const Intm  a, const Intm b) { return __make_Intm(static_cast<INTM_FAST_32>((INTM_FAST_64)(a.a) * (INTM_FAST_64)(b.a) % MOD)); }
...
struct node_t
{
  ...
  void push_down(node_t &a, node_t &b) {
    a.push_shift(shift), b.push_shift(shift); shift = 0; }
