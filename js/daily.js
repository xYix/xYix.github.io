(function(win){
    ...
    const DAILY_MESSAGES=[
        ...
        //歌词
            ...
            //月光 music
            '今だ銘々光れ　結構、月光のライトは明るい　凛々と生命照らす閃光　絶好のチャンス　手を叩きましょう',
            '感傷に銘々浸れ　結構、月光のライトは優しい　凛々と生命照らす閃光　絶頂ロマンス　手を叩きましょう',
            '再三に銘々光れ　結構、月光のライトは短い　凛々と生命望む羨望　最後のダンス　手を叩いてよ',
            ...
            '星は輝いて　物語は続いてた',
            '鐘鳴らせディンドンディンドン　キミの愛せる世界まで', //这绝对是对应那句もしも彼女が　世界を愛していたら……
            ...
            '金星のダンスは恥ずかしい　金星のダンスは恥ずかしいんだ　傍から見れば可笑しな踊りとは　知りながら　ダンス＆ダンス',
            '金星のダンスをやめにしたい　金星のダンスをやめにしたい',
            'ねえ　ぼくにもステップ教えて頂戴！　えっ？　無理ですか　そーですか',
            'あなたはぼくと踊ってくれますか？　えっ！　今ならいーんですか？',
            'この曲が終われば　誰が誰　金星のダンスで　オーデオーナイ！',
            //猫猫的宇宙论
            ...
            //木星节拍
            '木星のビートに乗っかって　君と宇宙へ行こう',
            '木星のビートに乗っかって　君と夢中で踊ろう',
            //银河电灯
            '銀河の明滅　青いライト　最終の列車　ふたりぼっちだった',
            '見えない空　濁った瞳　光った星に　迷った夜に　暗い世界　今は小さく見えた',
            'ふたり　眺める車窓　夜のむこう　光の海　パノラマがスライド',
